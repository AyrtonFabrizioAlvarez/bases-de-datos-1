...
- **El esquema `SUSCRIPCION` no esta en BCNF pues existe al menos el determinante de la DF2 donde {#suscripcion, email_adicional} no es superclave**  
    ...
    - No se pierden DF's ya que:
      - DF2 sigue valiendo para `S1`    
      - DF1, DF3, DF4, DF5, DF6 sigue valiendo para `S2`
    - Podemos entonces decir que `S1` esta en BCNF ya que el determinante de la DF2 es superclave en el esquema

- **El esquema `S2` no esta en BCNF pues existe el determinante de la DF3 donde {email} no es superclave**  
    ...
    - No se pierden DF's ya que:
      - DF3 sigue valiendo para `S3`
      - DF1, DF4, DF5, DF6 sigue valiendo para `S4`  
    - Podemos entonces decir que `S3` esta en BCNF ya que el determinante de la DF3 es superclave en el esquema 

- **El esquema `S4` no esta en BCNF pues existe al menos el determinante de la DF4 donde {email_adicional} no es superclave**  
    ...
    - No se pierden DF's ya que:
      - DF4 sigue valiendo para `S5`
      - DF1, DF5, DF6 siguen valiendo para `S6`  
    - Podemos entonces decir que `S5` esta en BCNF ya que el determinante de la DF4 es superclave en el esquema

- **El esquema `S6` no esta en BCNF pues existe al menos el determinante de la DF5 donde {#plan} no es superclave**  
    ...
    - No se pierden DF's ya que:
      - DF5 sigue valiendo para `S7`
      - DF1, DF6 sigue valiendo para `S8`
    - Podemos entonces decir que `S7` esta en BCNF ya que el determinante de la DF5 es superclave en el esquema

- **El esquema `S8` no estan en BCNF pues existe al menos el determinante de la DF6 donde {#contenido} no es superclave**  
    ...
    - No se pierden DF's ya que:
      - DF6 sigue valiendo para `S9`
      - DF1 sigue valiendo para `S10`
    - Podemos entonces decir que `S9` esta en BCNF ya que el determinante de la DF6 es superclave en el esquema
 
- **El esquema `S10` no esta en BCNF pues existe al menos el determinante de la DF1 donde {#suscripcion} no es superclave**  
    ...
    - Podemos entonces decir que `S11` esta en BCNF ya que el determinante de la DF1 es superclave en el esquema
...
- S13(<u>#suscripcion</u>, <u>email_adicional</u>)  
- S14(<u>#suscripcion</u>, <u>#contenido</u>) 
- Los esquemas `S1`, `S3`, `S5`, `S7`, `S9`. `S11` se encuentran en 4NF ya que ninguno presenta DM
- Los esquemas `S13`, `S14` se encuentra en 4NF ya que solo poseen DM's triviales